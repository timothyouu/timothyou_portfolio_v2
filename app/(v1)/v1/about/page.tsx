...
export default function About() {
  return (
    <div className="flex flex-row items-center justify-center gap-10 w-full max-w-[2000px] px-8 max-[480px]:px-4 py-8 box-border max-[768px]:flex-col max-[768px]:items-center">
      ...
      {/* Left column card */}
      <div className="flex flex-col items-center justify-around gap-10 bg-[#0A091A] rounded-[40px] p-8 max-[480px]:p-5 w-[500px] max-[1050px]:w-[300px] max-[768px]:w-full shrink h-[630px] max-[768px]:h-auto box-border">
        ...
        <Image
          ...
          width={300}
          height={250}
          className="rounded-[40px] object-cover w-auto max-h-[45%] max-[768px]:max-h-[180px] max-[480px]:max-h-[140px]"
        />
        ...
        <div className="bg-[#16142A] w-full rounded-[40px] p-5 pb-14 max-[768px]:pb-5 flex flex-col justify-around items-center gap-3 h-[50%] max-[768px]:h-auto box-border">
          ...
          <a
            ...
            className="bg-[#282450] w-[90%] py-5 max-[1050px]:py-3 max-[480px]:py-2 rounded-[32px] flex justify-center items-center text-[#D5B8E2] no-underline font-[family-name:var(--font-titan-one)] text-[2.5rem] max-[1050px]:text-[1.75rem] max-[480px]:text-[1.4rem] hover:bg-[#3f3b79] transition-colors"
          >
            Resume 📄
          </a>
      ...
      {/* Gallery card */}
      <div className="bg-[#0A091A] rounded-[40px] p-10 max-[1050px]:p-5 max-[480px]:p-4 grow shrink min-w-[500px] max-[1050px]:min-w-[250px] max-[768px]:min-w-0 max-[768px]:w-full h-[650px] max-[768px]:h-[450px] max-[480px]:h-[360px] flex flex-col gap-10 max-[1050px]:gap-4 justify-center items-center box-border">
